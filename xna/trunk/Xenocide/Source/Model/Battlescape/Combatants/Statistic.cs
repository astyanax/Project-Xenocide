...
namespace ProjectXenocide.Model.Battlescape.Combatants
{
    ...
    public enum Statistic
    {
        ...
        /// <summary>Number of fatal wounds in the head</summary>
        FatalWoundsHead,

        /// <summary>Number of fatal wounds in the body</summary>
        FatalWoundsBody,

        /// <summary>Number of fatal wounds in the left arm</summary>
        FatalWoundsLeftArm,

        /// <summary>Number of fatal wounds in the right arm</summary>
        FatalWoundsRightArm,

        /// <summary>Number of fatal wounds in the left leg</summary>
        FatalWoundsLeftLeg,

        /// <summary>Number of fatal wounds in the right leg</summary>
        FatalWoundsRightLeg,
        ...
        /// <summary>The number of stamina points left.</summary>
        StaminaLeft,
    ...
    public static class StaticticNames
    {
        ...
        private static readonly String[] displayStrings =
        {
            ...
            Strings.STATISTIC_INTERNAL_ONLY,  // FatalWoundsHead
            Strings.STATISTIC_INTERNAL_ONLY,  // FatalWoundsBody
            Strings.STATISTIC_INTERNAL_ONLY,  // EneFatalWoundsLeftArm
            Strings.STATISTIC_INTERNAL_ONLY,  // FatalWoundsRightArm
            Strings.STATISTIC_INTERNAL_ONLY,  // FatalWoundsLeftLeg
            Strings.STATISTIC_INTERNAL_ONLY,  // FatalWoundsRightLeg
            ...
            Strings.STATISTIC_INTERNAL_ONLY,  // StaminaLeft
