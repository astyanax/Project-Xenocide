...
namespace ProjectXenocide.Model.Geoscape
{
    ...
    public class Shipment
    {
        ...
        /// </summary>
        /// <param name="hours">set the hours it will take the shipment to arrive</param>
        /// <returns></returns>
        public static TimeSpan CalcEta(int hours)
        {
            return new TimeSpan(hours, 0, 0);
        }

        /// <summary>
        /// Figure out how long it will take shipment to arrive (used default of 48 hours)
        /// </summary>
        /// <returns></returns>
