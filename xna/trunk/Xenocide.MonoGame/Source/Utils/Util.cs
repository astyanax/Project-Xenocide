...
namespace ProjectXenocide.Utils
{
    ...
    public static class Util
    {
        ...
        public static Vector3[] CalcMeshExtents(ModelMesh mesh)
        {
            ...
            VertexDeclaration vertexDecl = vertexBuffer.VertexDeclaration;
            ...
            foreach (VertexElement element in vertexDecl.GetVertexElements())
            {
            ...
            int vertices = vertexBuffer.VertexCount;
            Debug.Assert((vertices * stride) == vertexBuffer.VertexCount * stride);

            // load vertex info where it can be read.
            byte[] buffer = new byte[vertexBuffer.VertexCount * stride];
            vertexBuffer.GetData<byte>(buffer);
        ...
        public static int GetShaderVersion(GraphicsDevice device)
        {
            return 3;
        }
