...
namespace ProjectXenocide.UI.Dialogs
{
    class AlienMissionDialog : Dialog
    {
        ...
        {
            // buttons
            missionTypeBox = CeGui.GuiBuilder.CreateComboBox("missionTypeBox");
        ...
        private void OnButtonClicked(object sender, CeGui.GuiEventArgs e)
        {
                ...
                {
                    AlienMission missionType = (AlienMission) Enum.Parse(typeof(AlienMission), missionTypeBox.SelectedItem.ToString());
