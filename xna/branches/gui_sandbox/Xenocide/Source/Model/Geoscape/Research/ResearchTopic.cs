...
namespace Xenocide.Model.Geoscape.Research
{
    ...
    public sealed class ResearchTopic
    {
        ...
        /// <summary>
        /// Advance the researchproject for one day. This of course only has effect if there are
        /// scientists assigned to this topic.
        /// If the advancement completes the research, its grants are automatically applied.
        /// </summary>
        /// <returns></returns>
        public bool NextDay()
        {
        ...
        public void Apply()
        {
            GameState state = Xenocide.GameState;
