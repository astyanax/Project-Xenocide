...
namespace Xenocide.UI.Dialogs
{
    ...
    class BuildFacilityDialog : Dialog
    {
        ...
        public BuildFacilityDialog(HumanBase humanBase, BasesScreen basesScreen)
        ...
        private void OnOkButton(object sender, CeGui.GuiEventArgs e)
        {
            ...
            if (null == item)
            {
                Xenocide.ScreenManager.ShowDialog(new MessageBoxDialog(Strings.MSGBOX_NO_FACILITY_SELECTED));
            }
            else
            {
