...
namespace Xenocide.UI.Dialogs
{
    ...
    public class NameNewBaseDialog : Dialog
    {
        ...
        private void OnOkClicked(object sender, CeGui.GuiEventArgs e)
        {
            ...
            Xenocide.GameState.GeoData.HumanBases.Add(humanBase);
            ...
            BasesScreen basesScreen = new BasesScreen(
                Xenocide.GameState.GeoData.HumanBases.Count - 1,
                ScreenManager
            );
            if (!isFirstBase)
            {
        ...
        private bool IsNameLegal(String name)
        {
            ...
            {
                ScreenManager.ShowDialog(new MessageBoxDialog(Strings.MSGBOX_BASE_NEEDS_NAME));
                return false;
            }
