...
namespace Xenocide.UI.Screens
{
    class BaseInfoScreen : Screen
    {
        ...
        public BaseInfoScreen(int selectedBaseIndex, ScreenManager screenManager)
            : base("BaseInfoScreen", screenManager)
        {
        ...
        protected override void CreateCeguiWidgets()
        {
            ...
            Misc.PopulateHumanBasesList(basesListComboBox, selectedBaseIndex);
        ...
        private void OnBaseSelectionChanged(object sender, WindowEventArgs e)
        {
            ...
            if (item != null)
            {
                ...
                ScreenManager.ScheduleScreen(new BaseInfoScreen(selectedBaseIndex, ScreenManager));
            }
        }
        ...
        {
            ScreenManager.ScheduleScreen(new BasesScreen(selectedBaseIndex, ScreenManager));
        }
        ...
        /// </summary>
        private HumanBase SelectedBase { get { return Xenocide.GameState.GeoData.HumanBases[selectedBaseIndex]; } }
