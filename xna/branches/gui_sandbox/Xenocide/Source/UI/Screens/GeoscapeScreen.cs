...
namespace Xenocide.UI.Screens
{
    ...
    public class GeoscapeScreen : PolarScreen
    {
        ...
        /// </summary>
        public GeoscapeScreen(ScreenManager screenManager)
            : base("GeoscapeScreen", screenManager)
        {
            Scene = new GeoscapeScene();

            Xenocide.GameState.GeoData.ResearchGraph.TopicResearched += TopicResearched;
        }
        ...
        protected override void CreateCeguiWidgets()
        {
            ...
            setFirstBaseTextWindow.Text = Strings.DLG_GEOSCAPE_FIRST_BASE;
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            String newTime = Xenocide.GameState.GeoData.GeoTime.ToString();
        ...
        private void ShowBasesScreen(object sender, CeGui.GuiEventArgs e)
        {
            ...
            {
                ScreenManager.ScheduleScreen(new BasesScreen(0, ScreenManager));
            }
        }
        ...
        private void ShowResearchDialog(object sender, CeGui.GuiEventArgs e)
        {
            if (GeoscapeScreenState.ViewGeoscape == state)
            {
                ScreenManager.ShowDialog(new ResearchDialog());
            }
        }
        ...
        private void ShowOptionsDialog(object sender, CeGui.GuiEventArgs e)
        {
            if (GeoscapeScreenState.ViewGeoscape == state)
            {
                ScreenManager.ShowDialog(new OptionsDialog());
            }
        }
        ...
        private void ShowStatisticsScreen(object sender, CeGui.GuiEventArgs e)
        {
            if (GeoscapeScreenState.ViewGeoscape == state)
            {
                ScreenManager.ScheduleScreen(new StatisticsScreen(ScreenManager));
            }
        }
        ...
        private void ShowXNetScreen(object sender, CeGui.GuiEventArgs e)
        {
            if (GeoscapeScreenState.ViewGeoscape == state)
            {
                ScreenManager.ScheduleScreen(new XNetScreen(ScreenManager));
            }
        }
        ...
        private void OnInterceptButtonClicked(object sender, CeGui.GuiEventArgs e)
        {
            if (GeoscapeScreenState.ViewGeoscape == state)
            {
                ...
                if (0 < Xenocide.GameState.GeoData.Overmind.Ufos.Count)
                {
                    ...
                    Aircraft aircraft = Xenocide.GameState.GeoData.HumanBases[0].Fleet[0];
        ...
        private static void StartPatrolMission(GeoPosition pos)
        {
                Aircraft aircraft = Xenocide.GameState.GeoData.HumanBases[0].Fleet[0];
                aircraft.Mission.Abort();
        ...
        private void ConfirmBasePositionDialog(GeoPosition pos)
        {
            ...
            {
                Xenocide.ScreenManager.QueueDialog(new NameNewBaseDialog(
                    pos, 
        ...
        {
            ScreenManager.ShowDialog(new MessageBoxDialog(Util.StringFormat(Strings.MSGBOX_RESEARCH_FINISHED, topic.Id)));
        }
