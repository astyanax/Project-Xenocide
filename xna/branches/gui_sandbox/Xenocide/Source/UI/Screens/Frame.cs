...
namespace Xenocide.UI.Screens
{
    ...
    public abstract class Frame : IDisposable
    {
        ...
        protected Frame(string ceguiId, ScreenManager screenManager, System.Drawing.SizeF size)
        {
        ...
        public virtual void LoadGraphicsContent(ContentManager content, GraphicsDevice device, bool loadAllContent)
        {
        }
