...
namespace ProjectXenocide.Model.StaticData.Facilities
{
    ...
    public class StorageFacilityInfo : FacilityInfo
    {
            ...
            : base(facilityNode, manager, false)
        {
            ...
            capacity = Util.GetIntAttribute(storage, "capacity");
        }

        #region Methods

        /// <summary>
        /// Is facility being used in this outpost?
        /// </summary>
        /// <param name="statistics">outpost facility is in</param>
        /// <returns>true if facility is being used</returns>
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1062:ValidateArgumentsOfPublicMethods",
          Justification = "will throw if statistics == null")]
        public bool IsFacilityInUse(OutpostStatistics statistics)
        {
            // facility is in use if outpost has less free capacity than this facility provides.
            OutpostCapacityInfo info = statistics.Capacities[storageType];
        ...
        protected override void StartBuildingCore(OutpostStatistics statistics)
        {
