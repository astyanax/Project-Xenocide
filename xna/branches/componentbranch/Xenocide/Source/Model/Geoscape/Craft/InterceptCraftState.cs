...
namespace Xenocide.Model.Geoscape.Craft
{
    ...
    public class InterceptCraftState : MissionState
    {
        ...
        public override void OnFuelLow() 
        {
            ...
            //TODO: reenable this, once we have a Game reference here
            /*
            ScreenManager.QueueDialog(
                new MessageBoxDialog(null, Util.StringFormat(Strings.MSGBOX_FUEL_LOW, Mission.Craft.Name))
            );
             */
            Mission.SetState(new ReturnToBaseState(Mission));
        }
