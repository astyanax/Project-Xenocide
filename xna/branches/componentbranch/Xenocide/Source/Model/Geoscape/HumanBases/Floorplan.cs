...
namespace Xenocide.Model.Geoscape.HumanBases
{
    ...
    public class Floorplan
    {
        ...
        public void Update(double milliseconds)
        {
            ...
            {
                UpdateUnfinishedFacilities(true);
            }
        }
        ...
        public void AddFacility(FacilityHandle handle)
        {
            ...
            UpdateUnfinishedFacilities(false);
        ...
        /// </summary>
        /// <param name="raiseEvent">if a facility is finished, should an event be raised?</param>
        public void UpdateUnfinishedFacilities(bool raiseEvent)
        {
            // update facilities
            foreach (int index in unfinishedFacilities.Values)
            {
                ...
                if (handle.TimeToBuild <= secondsSinceLastBuildUpdate)
                {
                    ...
                    if (raiseEvent)
                    {
                        GeoEvent geoevent = new FacilityFinishedGeoEvent(handle);
        ...
        public static void RunTests()
        {
            ...
            //TODO: Reenable this once we have a reference to Game here
            /*
            ScreenManager.ShowDialog(new MessageBoxDialog(null, "UnitTestsFinished"));
            */
        }
