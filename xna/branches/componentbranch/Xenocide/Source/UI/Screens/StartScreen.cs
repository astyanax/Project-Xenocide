...
namespace Xenocide.UI.Screens
{
    ...
    public class StartScreen : Screen
    {
        ...
        {
            startButton = AddButton("BUTTON_NEW_GAME",        0.3500f, 0.4000f, 0.3000f, 0.1333f);
        ...
        {
            ((IGameStateService)Game.Services.GetService(typeof(IGameStateService))).NewGame();
