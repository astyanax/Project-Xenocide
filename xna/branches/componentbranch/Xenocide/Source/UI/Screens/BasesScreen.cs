...
namespace Xenocide.UI.Screens
{
    ...
    public class BasesScreen : Screen
    {
        ...
        public BasesScreen(Game game, int selectedBase)
            : base(game, "BasesScreen")
        {
        ...
        public override void Initialize()
        {
            ...
            scene = new FacilityScene(Game, SelectedBaseFloorplan);
            base.Initialize();

            Game.Components.Add(scene);
            scene.SceneWindow = sceneWindow.Rect;
            // Before showing, bring floorplan up to date 
            SelectedBaseFloorplan.UpdateUnfinishedFacilities(false);
        }
        ...
        protected override void CreateCeguiWidgets()
        {
            ...
            Misc.PopulateHumanBasesList(humanBaseService.HumanBases, basesListComboBox, selectedBase);
        ...
        private void OnBaseSelectionChanged(object sender, WindowEventArgs e)
        {
            if (BasesScreenState.NotAdding == state)
            {
                ...
                if (item != null)
                {
                    ...
                    ScreenManager.ScheduleScreen(new BasesScreen(Game, selectedBase));
                }
            }
        }
        ...
        private void ShowBaseInfoScreen(object sender, CeGui.GuiEventArgs e)
        {
            if (BasesScreenState.NotAdding == state)
            {
                ScreenManager.ScheduleScreen(new BaseInfoScreen(Game, selectedBase));
            }
        }
        ...
        private void OnNewBase(object sender, CeGui.GuiEventArgs e)
        {
            ...
            if (8 <= humanBaseService.HumanBases.Count)
            {
                ScreenManager.ShowDialog(new MessageBoxDialog(Game, Strings.MSGBOX_MAX_EIGHT_BASES));
            }
            else
            {
                // stop time
                ...
                GeoscapeScreen geoscapeScreen = new GeoscapeScreen(Game);
        ...
        {
            HumanBase humanBase = humanBaseService.HumanBases[selectedBase];
            if (BasesScreenState.NotAdding == state)
            {
                ...
                {
                    ScreenManager.ShowDialog(new BuildFacilityDialog(Game, humanBase, this));
                }
            }
        }
        ...
        private void AddFacility(Microsoft.Xna.Framework.Vector2 cellCoords)
        {
            ...
            {
                ScreenManager.ShowDialog(new MessageBoxDialog(Game, Util.GetErrorMessage(error)));
            }
        }
        ...
        IHumanBaseService humanBaseService;
        ...
        { 
            get { return humanBaseService.HumanBases[selectedBase].Floorplan; } 
        }
