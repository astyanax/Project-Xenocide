...
namespace Xenocide.UI.Screens
{
    ...
    /// </summary>
    public class ScreenManager : GameComponent, IScreenManager, IDisposable
    {
        ...
        private void SwapScreens()
        {
            ...
            Game.Components.Add(nextScreen);
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            {
                /*
                //do we need this check? Rincewind
