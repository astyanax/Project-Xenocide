...
namespace Xenocide.UI.Scenes.Facility
{
    ...
    class BuildTimes
    {
        ...
        {
            texture = content.Load<Texture2D>("Content\\Textures\\BuildTimes");
            InitializeMesh();
        ...
        private void AddQuadToMesh(FacilityHandle handle, int quadNum)
        {
            ...
            meshIndices[iIndex + 1] = (short)(vIndex + 1);
            meshIndices[iIndex + 2] = (short)(vIndex + 2);
            meshIndices[iIndex + 3] = (short)(vIndex + 2);
            meshIndices[iIndex + 4] = (short)(vIndex + 1);
            meshIndices[iIndex + 5] = (short)(vIndex + 3);
        }
