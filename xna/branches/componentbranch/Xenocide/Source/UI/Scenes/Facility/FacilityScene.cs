...
{
    /// <summary>
    /// Shows the facilities (and their layout) in a human base.
    /// </summary>
    public class FacilityScene : EmbeddedScene, IDisposable
    {
        /// <summary>
        /// Constructor
        /// </summary>
        ...
        public FacilityScene(Game game, Floorplan floorplan)
            : base(game)
        {
            this.floorplan      = floorplan;
            this.grid           = new Grid(floorplan.CellsWide, floorplan.CellsHigh);
        ...
        protected override void LoadGraphicsContent(bool loadAllContent) {
            if (loadAllContent)
            {
                ...
                models.LoadGraphicsContent(ContentManager);
                buildTimes.LoadGraphicsContent(ContentManager, device);
            }
        }
