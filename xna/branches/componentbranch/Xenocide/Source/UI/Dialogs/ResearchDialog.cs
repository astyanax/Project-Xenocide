...
namespace Xenocide.Source.UI.Dialogs
{
    ...
    {
        public ResearchDialog(Game game)
        ...
        {
            int id = 0;
            foreach(ResearchTopic topic in researchService.CurrentResearchProjects)
            {
        ...
        {
            ScreenManager.ShowDialog(new AddResearchDialog(Game, this));
        }
