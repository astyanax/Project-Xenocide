...
{
    class StartAeroscapeDialog : Dialog
    {
        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="hunter">Craft that is attacking</param>
        /// <param name="target">Craft that is being attacked</param>
        public StartAeroscapeDialog(Game game, Craft hunter, Craft target)
        ...
        protected override void CreateCeguiWidgets()
        {
            ...
            textWindow.Text = Strings.ResourceManager.GetString("MSGBOX_AEROSCAPE_START");
        ...
        {
            // Tell UFO that it was shot down
            target.OnDogfightFinished();
        ...
        /// <summary>
        /// Craft that is being attacked
        /// </summary>
        private Craft target;

        /// <summary>
        /// Craft that is attacking
        /// </summary>
