...
/// </summary>
[ AlternateWidgetName("TaharezLook.TLListbox") ]
public class TLListbox : Listbox {
  ...
  public TLListbox(string type, string name)
    : base(type, name) {
  ...
  protected override void LayoutComponentWidgets() {
    ...
    vertScrollbar.Position = new PointF(1.0f - verticalSize.Width, 0.0f);

    // position horizontal scroll bar
    horzScrollbar.Position = new PointF(0.0f, 1.0f - horizontalSize.Height);
  }
