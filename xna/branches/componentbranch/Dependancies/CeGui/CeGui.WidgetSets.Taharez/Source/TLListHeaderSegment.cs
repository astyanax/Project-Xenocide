...
/// </summary>
[ AlternateWidgetName("TaharezLook.TLListHeaderSegment") ]
public class TLListHeaderSegment : ListHeaderSegment {
  ...
  public TLListHeaderSegment(string type, string name)
    : base(type, name) {
  ...
  protected void RenderSegmentImagery(Vector3 position, float alpha, Rect clipper) {
    ...
    ColourRect colors = new ColourRect(new Colour(1, 1, 1, alpha));
