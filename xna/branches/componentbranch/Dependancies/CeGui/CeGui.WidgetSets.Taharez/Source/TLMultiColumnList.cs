...
/// </summary>
[ AlternateWidgetName("TaharezLook.TLMultiColumnList") ]
public class TLMultiColumnList : MultiColumnList {
  ...
  public TLMultiColumnList(string type, string name)
    : base(type, name) {
    ...
    background.Position = new PointF(leftFrameSize, topFrameSize);
  ...
  protected override void LayoutComponentWidgets() {
    ...
    PointF headerPosition = AbsoluteToRelative(new PointF(leftFrameSize, topFrameSize));
    ...
    verticalScrollbar.Position = new PointF(1.0f - verticalSize.Width, headerSize.Height + headerPosition.Y);

    // position horizontal scroll bar
    horizontalScrollbar.Position = new PointF(0.0f, 1.0f - horizontalSize.Height);
  }
