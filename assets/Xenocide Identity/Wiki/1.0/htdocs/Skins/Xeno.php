 ...
 * @addtogroup Skins
 */
class SkinXeno extends SkinTemplate {
	/** Using Xeno. */
	function initPage( &$out ) {
		SkinTemplate::initPage( $out );
		$this->skinname  = 'Xeno';
		$this->stylename = 'Xeno';
		$this->template  = 'XenoTemplate';
	}
}
 ...
 * @addtogroup Skins
 */
class XenoTemplate extends QuickTemplate {
	/**
	 * Template filter callback for Xeno skin.
...
<?php		}
		...
		wfRunHooks( 'XenoTemplateToolboxEnd', array( &$this ) );
?>
			</ul>
		</div>
	</div>
