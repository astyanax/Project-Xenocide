...
namespace ProjectXenocide.UI.Scenes.Battlescape
{
    ...
    public class Camera
    {
        ...
        public void Update(GameTime gameTime)
        {
            ...
            float displacement = (float)gameTime.ElapsedGameTime.TotalMilliseconds * 0.02f;
            ...
            float rotation = (float)gameTime.ElapsedGameTime.TotalMilliseconds * MathHelper.Pi * 0.001f;
            float yaw = 0.0f;
            float pitch = 0.0f;
